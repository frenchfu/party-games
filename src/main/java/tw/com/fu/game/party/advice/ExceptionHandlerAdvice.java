package tw.com.fu.game.party.advice;
...
import tw.com.fu.game.party.vo.response.AllOutResponse;
...
public class ExceptionHandlerAdvice extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler({PartyGamesException.class})
    private ResponseEntity exceptionHandler(PartyGamesException ex){
