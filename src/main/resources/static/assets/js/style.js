...
var stack = Composites.stack(sW/2 - (shapeAmount * shapeSize),sH/2 - (shapeAmount * shapeSize), shapeAmount,shapeAmount, 0, 0, function(x, y) {
...
var explosion = function(engine) {
        ...
        for (var i = 0; i < bodies.length; i++) {
            ...
            if (!body.isStatic && body.position.y >= (sW/2+r)*0.92) {
